sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/pepethefrog/app", ".html");
		...
		return Opa5.extend("zjblessons.pepethefrog.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/pepethefrog/localService/mockserver"], function (mockserver) {
