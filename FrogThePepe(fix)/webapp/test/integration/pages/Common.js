sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("zjblessons/FrogThePepe/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("zjblessons.FrogThePepe.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["zjblessons/FrogThePepe/localService/mockserver"], function (mockserver) {
