sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("zjblessons.FrogThePepe.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias zjblessons.FrogThePepe.controller.ListSelector
			 */
			 ...
			 * @return {zjblessons.FrogThePepe.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
